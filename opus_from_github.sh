...
if [ ! -e "${SRCDIR}/opus-${VERSION}.tar.gz" ]; then
    ...
    curl -LO https://github.com/xiph/opus/archive/v1.3.1.tar.gz
    mv v1.3.1.tar.gz opus-v1.3.1.tar.gz
fi
echo "Using opus-v${VERSION}.tar.gz"

tar zxf opus-v${VERSION}.tar.gz
...
do
    ...
    # Not sure why there is no configure with latest build
    ./autogen.sh
    ./configure \
